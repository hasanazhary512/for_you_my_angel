...
function playMusic() {
  ...
  music.loop = true; // Musik akan diulang terus
  music.play();
}
  ...
  x = setInterval(function () {
    ...
    document.getElementById('hours').innerText = Math.floor(distance / (hour)),
      ...
      if (distance < 0) {
        ...
        // Menampilkan tanggal ulang tahun setelah countdown selesai
        const birthdayDate = document.createElement('div');
        birthdayDate.innerText = '28 Mei 2025';
        birthdayDate.style.fontSize = '2rem';
        birthdayDate.style.textAlign = 'center';
        birthdayDate.style.marginTop = '20px';
        timer.parentElement.appendChild(birthdayDate);
...
new TypeIt("#teks1", {
  strings: ["Hari ini, saya langitkan semua doa terbaik saya untuk Engga Setya Dewi.", "Semoga hal-hal yang membuat kamu runtuh turut menjadi alasan kamu untuk tetap tumbuh.", "Semoga dunia senantiasa menjaga kamu dimanapun kamu berada.", "Semoga hari-hari kamu selalu diiringi cinta yang tak pernah ada batasnya." , "Semoga setiap langkahmu dimudahkan hingga tercapai apa yang kamu inginkan."],
  startDelay: 4000,
  speed: 75,
...
function confetti() {
  ...
  function poof() {
    if (!frame) {
      ...
      // Tambahkan event listener ke tombol "Suka!!"
document.getElementById('suka').addEventListener('click', function() {
  window.location.href = '../draw.html'; // Arahkan ke halaman terimakasih.html
});
